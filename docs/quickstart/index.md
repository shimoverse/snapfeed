...
- **Pinned to snapfeed v0.4.0.** When you see API names like `autoAdapters`, `defineRouting`, `createFeedbackHandler`, those are the real exports — not invented for the docs.
